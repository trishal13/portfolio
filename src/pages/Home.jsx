...
//         <p className="text-5xl font-extrabold text-transparent bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text animate-gradient-background hover:scale-110 transition-transform duration-300 ease-in-out">
...
//         />
//       </div>
//       <div className="text-white flex space-x-6 mt-8 justify-center flex-wrap">
//         <InfoCard 
//           icon={<FaBirthdayCake />} 
...
const Home = () => {
  return (
    <div className="flex flex-col items-center min-h-screen">
      ...
      <div className="text-white flex flex-wrap space-x-6 mt-8 justify-center">
        <InfoCard
          icon={<FaBirthdayCake />}
          infoValue={info?.dateOfBirth}
        />
